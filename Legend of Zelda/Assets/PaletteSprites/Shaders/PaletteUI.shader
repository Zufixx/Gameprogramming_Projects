...
#pragma multi_compile __ UNITY_UI_ALPHACLIP
	...
	fixed4 frag(v2f IN) : SV_Target
	{
		...
		float4 pc = getPaletteColor(c.r, _Palette, _PaletteSize, _PaletteTex);

		pc.a = c.a * UnityGet2DClipping(IN.worldPosition.xy, _ClipRect);
		
#ifdef UNITY_UI_ALPHACLIP
		clip(pc.a - 0.001);
#endif

		return (pc +_TextureSampleAdd) * IN.color;
	}
		ENDCG
	}
	}
